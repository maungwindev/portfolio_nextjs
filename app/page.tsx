...
const projects = [
  ...
  },
  {
    ...
    tech: ["Flutter", "Dart", "Get X", "SQLite", "Firebase Notification"],
  ...
  },
  {
    ...
    category: "Flutter",
    description: "Learning how baby are growing to adultThe ECCD@Home mobile application is developed to address the critical need for caregiver engagement in early childhood care and development (ECD) in Myanmar, particularly exacerbated by the COVID-19 pandemic and then political instabilities.",
    image: "/maymay.png?height=200&width=200",
    tech: ["Flutter", "Dart", "Get X", "Secure Storage","Firebase Notification"],
  ...
  },
  {
    ...
    category: "Flutter",
    description: "SAFE Delivery App is simple and easy to use. Send and Track. All your shipping requirements in one App.Whether you want to send a parcel, pickup cash for an e-commerce sales order, SAFE will make it.",
    image: "/safe_delivery.png?height=300&width=400",
    tech: ["Flutter", "Dart", "Bloc", "Keychain"],
  ...
  },
  {
    ...
    category: "Flutter",
    description: "Golden Thailand is managing POS App in Restaurant By using Sunmi Device.",
    image: "/golden_thailand.png?height=300&width=400",
    tech: ["Flutter", "Dart", "Bloc", "Flutter Secure Storage","Sunmi Package","Printer"],
  ...
  },
  {
    ...
    tech: ["Flutter", "Dart", "Firebase", "Mobx","Flutter Secure Storage","Hive","Player library"],
